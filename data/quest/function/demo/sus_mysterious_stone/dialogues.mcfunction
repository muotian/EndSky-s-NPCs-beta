...
data modify storage quest:demo sus_mysterious_stone.Start set value {Texts:[{"text":"天天可以拜託你一件事嗎"},{"text":"聽說教主浩浩有在販售一種詭異的石頭"},{"text":"好像是叫做「神奇又不神奇的石頭」吧"},{"text":"天天想要買個三塊這種石頭\n測試它們在建築上面的效果"},{"text":"但是天天的肝已經快要爆炸了"},{"text":"總之能請你幫我跑一趟嗎?"}],Options:{NoExit:1b,List:[{Option:{"text":"接受任務"},React:[{"text":"謝謝!"},{"text":"天天會多付你一點的"}],Extra:{EndCommand:"function quest:demo/sus_mysterious_stone/start"}},{Option:{"text":"拒絕任務"},React:[{"text":"沒關係..."},{"text":"天天還不會升天的..."}]}]}}
...
data modify storage quest:demo sus_mysterious_stone.Item set value {Texts:[{"text":"去找教主浩浩買石頭了嗎?"}],Options:{NoExit:1b,List:[{Option:{"text":"交出石頭"},React:[{"text":"謝謝你"},{"text":"你幫了大忙"},{"text":"這是說好的報酬"}],Condition:{Type:"item",Value:{item_predicate:"minecraft:stone[minecraft:custom_data~{mysterious_stone:{},not_mysterious_stone:{}}]",count:3b}},Extra:{StartCommand:"function quest:demo/sus_mysterious_stone/take",EndCommand:"function quest:demo/sus_mysterious_stone/finish"}},{Option:{"text":"不交出石頭"},React:[{"text":"慢慢來吧"},{"text":"天天不會跑掉的"}]}]}}

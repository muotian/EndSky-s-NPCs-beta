...
data modify storage quest:demo mysterious_stone.Start set value {Texts:[{"text":"喔你來得正好"},{"text":"創辦人那裡似乎出了點問題"},{"text":"要求我尋找一個叫做「神奇石頭」的道具"},{"text":"我記得 ","extra":[{"underlined":true,"text":"測試用末天機器人"},{"text":" 那邊有很多"}]},{"text":"不過目前我手邊要處理的事太多了"},{"text":"能請你幫我去跟他拿嗎"}],Options:{NoExit:1b,List:[{Option:{"text":"接受任務"},React:[{"text":"拜託了!"}],Extra:{EndCommand:"function quest:demo/mysterious_stone/start"}},{Option:{"text":"拒絕任務"},React:[{"text":"沒關係"},{"text":"那我稍後再找時間去跟他拿"}]}]}}
...
data modify storage quest:demo mysterious_stone.Turn_In set value {Texts:[{"text":"你拿到神奇石頭了嗎"}],Options:{NoExit:1b,List:[{Option:{"text":"交出石頭"},React:[{"text":"喔~有了!"},{"text":"真的是太感謝你了"},{"text":"雖然算不上什麼謝禮"},{"text":"不過還請你收下這個吧"}],Condition:{Type:"item",Value:{item_predicate:"minecraft:stone[minecraft:custom_data~{mysterious_stone:{}}]",count:1}},Extra:{StartCommand:"function quest:demo/mysterious_stone/take",EndCommand:"function quest:demo/mysterious_stone/finish"}},{Option:{"text":"暫時不交出石頭"},React:[{"text":"還沒拿到嗎"},{"text":"我在這裡等你喔"}]}]}}

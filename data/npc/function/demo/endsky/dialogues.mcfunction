...
data modify storage npc:demo endsky.Normal append value {Texts:['{"text":"就算是機器人"}','{"text":"一直站著"}','{"text":"也還是會覺得腿痠的"}','{"italic":true,"text":"好想休息啊啊啊"}'],Extra:{SoundOverrides:[{index:3,pool:[{id:"minecraft:entity.cat.ambient",setting:{pitch:0.5}}]}]}}
...
data modify storage npc:demo endsky.Normal append value {Texts:['{"text":"當你聽到這句話的時候——"}','{"text":"欸?"}','{"text":"你說這其實是「看到」?"}','{"text":"等等"}','{"text":"你能§c聽得到§r引號嗎?"}','{"text":"你說紅色?"}','{"text":"我......好像快瘋了"}'],Extra:{SoundOverrides:[{index:4,pool:[{id:"minecraft:entity.cat.ambient",setting:{pitch:0.5f}}]},{index:5,pool:[{id:"minecraft:entity.cat.ambient",setting:{pitch:0.5f}}]},{index:6,pool:[{id:"minecraft:entity.cat.death",setting:{pitch:0.5f}}]}]}}

data modify storage npc:demo endsky.SoundPool set value [{id:"minecraft:entity.pillager.ambient"},{id:"minecraft:entity.vindicator.ambient"}]

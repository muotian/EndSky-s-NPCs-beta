...
execute if data storage endsky_npc:trader Interpret.Item.buy.components run data modify storage endsky_npc:trader Interpreted.Buy[-1].buy.components set from storage endsky_npc:trader Interpret.Item.buy.components
...
execute if data storage endsky_npc:trader Interpret.Item.buyB.components run data modify storage endsky_npc:trader Interpreted.Buy[-1].buyB.components set from storage endsky_npc:trader Interpret.Item.buyB.components
...
execute if data storage endsky_npc:trader Interpret.Item.sell.components run data modify storage endsky_npc:trader Interpreted.Buy[-1].sell.components set from storage endsky_npc:trader Interpret.Item.sell.components

...
execute if score $next npc.state matches 1 unless data storage endsky_npc:common Data.Dialogue{Option:1b} if data storage endsky_npc:common Data.Dialogue.Options run scoreboard players set $next npc.state 2
execute if score $next npc.state matches 1 if data storage endsky_npc:common Data.Dialogue{Option:1b} if data storage endsky_npc:common Data.Dialogue.Options{LoopBack:1b} run scoreboard players set $next npc.state 2
...
execute if score $next npc.state matches 2 run data modify storage endsky_npc:common Data.Dialogue.Option set value 1b
execute if score $next npc.state matches 3 run data remove storage endsky_npc:common Data.Dialogue.Option
execute if score $next npc.state matches 3 run function endsky_npc:trader/get_override with storage endsky_npc:common Data.Id

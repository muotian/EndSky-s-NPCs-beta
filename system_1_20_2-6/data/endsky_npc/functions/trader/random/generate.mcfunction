# executed by marker
execute store result score $dialogue npc.count run data get storage endsky_npc:common Data.TraderNormal
...
execute unless data storage endsky_npc:utils output{value:0} run function endsky_npc:trader/random/swap with storage endsky_npc:utils output
